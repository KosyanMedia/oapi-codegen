// Package custom_comments provides primitives to interact with the openapi HTTP API.
//
...
// OneComment defines model for OneComment.
// easyjson:json
